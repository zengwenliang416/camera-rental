...
public class XianyuConfiguration {
    ...
    @Bean
    public XianyuReadClient xianyuReadClient(XianyuRuntimeConfigService runtimeConfigService,
                                              XianyuCanonicalJson canonicalJson,
                                              XianyuRequestSigner requestSigner, OkHttpClient xianyuReadOkHttpClient,
                                              ObjectMapper objectMapper,
                                              @Qualifier("xianyuClock") Clock clock) {
        return new XianyuReadClient(runtimeConfigService, canonicalJson, requestSigner, xianyuReadOkHttpClient,
                objectMapper, clock);
    }

    @Bean
    public XianyuWriteClient xianyuWriteClient(XianyuRuntimeConfigService runtimeConfigService,
                                               XianyuCanonicalJson canonicalJson,
                                               XianyuRequestSigner requestSigner, OkHttpClient xianyuReadOkHttpClient,
                                               ObjectMapper objectMapper,
                                               @Qualifier("xianyuClock") Clock clock) {
        return new XianyuWriteClient(runtimeConfigService, canonicalJson, requestSigner, xianyuReadOkHttpClient,
                objectMapper, clock);
    }

    @Bean
    public XianyuWebhookSignatureVerifier xianyuWebhookSignatureVerifier(
                                                                           XianyuRuntimeConfigService runtimeConfigService,
                                                                           XianyuRequestSigner requestSigner,
                                                                           @Qualifier("xianyuClock") Clock clock) {
        return new XianyuWebhookSignatureVerifier(runtimeConfigService, requestSigner, clock);
    }
