export default {
  ...
  rental: {
    ...
    xianyu: {
      ...
      shipWorkbenchTitle: 'Scan-to-ship workbench',
      shipWorkbenchHint:
        'Recognize the courier waybill image first, scan the device serial QR, search pending shipment orders, then confirm. Binding and XianGuanJia shipping are validated by the backend.',
      ...
      shipOrderTitle: '3. Search pending orders',
      ...
      pendingKeyword: 'Order keyword',
      pendingKeywordPlaceholder: 'Order no., goods, buyer, receiver, or phone',
      searchPendingShip: 'Search pending shipment',
      pendingShipEmptyHint:
        'No pending shipment candidates. Check shop, keyword, or sync/convert orders first.',
