export default {
  ...
  rental: {
    ...
    xianyu: {
      ...
      deviceSearchLabel: 'Search for a device',
      deviceSearchMore: 'Load more devices',
      deviceSearchClearFilters: 'Clear category filters',
      deviceCascadeLabel: 'Category and model (optional filters, filled after selection)',
      deviceCascadeCategoryPlaceholder: 'Category',
      deviceCascadeModelPlaceholder: 'Model',
      deviceCascadeDevicePlaceholder: 'Search device number or serial number across categories',
      deviceScanHint:
    ...
    orderCreate: {
      ...
      customerMobilePlaceholder: 'Enter an 11-digit mobile; existing customer info loads on blur',
      customerMobileRequired: 'Enter the mobile number',
      customerMobileFormat: 'Enter an 11-digit mobile number',
      customerWechatId: 'WeChat ID',
      ...
      itemRentAmount: 'Rent (CNY)',
      itemRentAmountRequired: 'Enter the rent amount',
      addItem: 'Add row',
      removeItem: 'Remove',
      catalogLoadError:
        'Failed to load the device model catalog. Check the network or permissions and retry.',
      periodTitle: 'Rental period',
      billableStartDate: 'Start date',
      billableStartDatePlaceholder: 'Select start date',
      billableEndDate: 'End date',
      billableEndDatePlaceholder: 'Select end date',
      billableDateRequired: 'Select the rental start and end dates',
      billableDateInvalid: 'Start date cannot be earlier than today or later than the end date',
      amountTitle: 'Amounts',
      ...
      deliveryMethodSelfDelivery: 'Self pickup',
      expressHint:
        'Arrange express shipment offline after creation; no waybill is recorded in this phase.',
      receiverName: 'Receiver',
      receiverNamePlaceholder: 'Enter receiver name',
      receiverNameRequired: 'Enter the receiver name',
      receiverMobile: 'Receiver phone',
      receiverMobilePlaceholder: 'Enter receiver phone',
      receiverMobileRequired: 'Enter the receiver phone',
      receiverAddress: 'Receiver address',
      receiverAddressPlaceholder: 'Enter receiver address',
      receiverAddressRequired: 'Enter the receiver address',
