export default {
  ...
  rental: {
    ...
    device: {
      ...
      deviceNoPrefixHint: 'Device creation combines this prefix with the administrator-entered number',
      ...
      deviceNoSuffixHint: 'Enter the number and the system will append it to the selected model prefix',
