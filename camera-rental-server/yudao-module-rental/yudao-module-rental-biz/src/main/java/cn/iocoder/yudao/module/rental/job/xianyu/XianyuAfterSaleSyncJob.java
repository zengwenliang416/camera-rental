...
public class XianyuAfterSaleSyncJob implements JobHandler {
    ...
    public XianyuAfterSaleSyncJob(XianyuChannelSyncService channelSyncService, XianyuProperties properties) {
    ...
    public String execute(String param) {
        return TenantUtils.execute(properties.requireTenantId(), channelSyncService::syncAfterSalesIncremental);
    }
