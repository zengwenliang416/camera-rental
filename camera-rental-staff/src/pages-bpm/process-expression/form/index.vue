    ...
    <view>
      <wd-form ref="formRef" :model="formData" :schema="formSchema">
        <wd-cell-group border>
          <wd-form-item title="表达式名字" title-width="180rpx" prop="name">
            <wd-input
          ...
          <wd-form-item title="表达式状态" title-width="180rpx" prop="status" center>
          ...
          <wd-form-item title="表达式" title-width="180rpx" prop="expression">
            <wd-textarea
