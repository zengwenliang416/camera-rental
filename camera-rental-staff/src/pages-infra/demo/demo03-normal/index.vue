...
import type { Demo03Student } from '@/api/infra/demo/demo03/normal'
import { onMounted, onUnmounted, ref } from 'vue'
import { getDemo03StudentPage } from '@/api/infra/demo/demo03/normal'
...
function handleAdd() {
  uni.navigateTo({
    url: '/pages-infra/demo/demo03-normal/form/index',
  })
}
...
function handleDetail(item: Demo03Student) {
  uni.navigateTo({
    url: `/pages-infra/demo/demo03-normal/detail/index?id=${item.id}`,
  })
}

/** 初始化 */
onMounted(() => {
  uni.$on('infra:demo03-normal:reload', reload)
})

/** 卸载 */
onUnmounted(() => {
  uni.$off('infra:demo03-normal:reload', reload)
})
</script>
