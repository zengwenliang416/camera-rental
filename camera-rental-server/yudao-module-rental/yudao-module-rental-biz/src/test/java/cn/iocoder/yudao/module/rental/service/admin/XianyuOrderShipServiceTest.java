...
class XianyuOrderShipServiceTest {
    ...
    private XianyuOrderShipService service() {
        return new XianyuOrderShipService(orderMapper, shopMapper, deviceMapper, rentalOrderMapper,
                rentalOrderItemMapper, shipmentMapper, assignmentService, deviceOpsService, writeClient,
