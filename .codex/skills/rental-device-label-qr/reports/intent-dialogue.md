...
- Decision: `proceed`
- Current understanding: Generate repeatable, print-ready rental device QR label packages in the approved shop-label layout. Primary output: Verified 20x40 mm 600 DPI PNG labels, A4 print PDF, preview sheet, normalized manifest, and ZIP archive.. Exclusions: Do not create or expose signing secrets, mutate production data, change the CRD1 protocol, or route generic QR design tasks here..
...
- Capability sentence: Rental Device Label QR should turn a recurring request into a reliable reusable output without widening the boundary unnecessarily.
