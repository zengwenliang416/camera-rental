export default {
  ...
  rental: {
    ...
    device: {
      ...
      deviceNoPrefixHint: 'Device numbers will use this prefix with sequences 01-99',
      ...
      deviceNoAutoPlaceholder: 'Select a model to preview the number range',
      deviceNoAutoHint: 'The backend assigns the final device number from the model prefix',
