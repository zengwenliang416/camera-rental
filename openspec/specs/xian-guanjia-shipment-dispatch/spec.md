# xian-guanjia-shipment-dispatch Specification

## Purpose

Define the safe, confirmed dispatch workflow for shipping pending
XianGuanJia channel orders from the camera rental platform.
