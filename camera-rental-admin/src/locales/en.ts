export default {
  ...
  rental: {
    ...
    xianyu: {
      ...
      pendingKeywordPlaceholder: 'Order no., goods title, or buyer nickname',
    ...
    order: {
      ...
      listHintShort:
        'Local DB list. After sync, remarks are parsed and conversion runs automatically. Incomplete remarks go to review; "Retry convert" is fallback only.',
