...
async function queryList(pageNo: number, pageSize: number) {
  try {
    const data = await getPayRefundPage({ ...queryParams.value, pageNo, pageSize })
...
/** 查看详情 */
function handleDetail(item: PayRefund) {
  uni.navigateTo({ url: `/pages-pay/refund/detail/index?id=${item.id}` })
}
</script>
